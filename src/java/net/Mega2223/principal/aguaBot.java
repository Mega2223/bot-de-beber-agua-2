package java.net.Mega2223.principal;
...
import java.lavaplayer.PlayerManager;
import java.net.Mega2223.utils.Janela;
import java.net.Mega2223.utils.PingPongMatch;
import java.net.Mega2223.utils.TextFileModifier;
    ...
    public static class seraQueEuLembroComoUsaEventListeners extends ListenerAdapter { //lembro?
        ...
        public void onGuildMessageReceived(final GuildMessageReceivedEvent event) {
            ...
            if (censoredUsers.contains(event.getAuthor())) {
                ...
                for (java.net.Mega2223.principal.notifier notifier : Notifiers) {
                    notifier.dispose();
